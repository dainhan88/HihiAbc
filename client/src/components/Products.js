    ...
    <div>
      <div className="flex page-container items-center text-white justify-around  bg-slate-50  h-full py-2 font-semibold rounded-md cursor-pointer ">
        <a className="w-[120px] hover:scale-125" href="">
          <img src="https://logos-world.net/wp-content/uploads/2020/08/Dell-Logo.png"></img>
        </a>
        <a className="w-[120px] hover:scale-125" href="">
          <img src="https://cdn4.iconfinder.com/data/icons/flat-brand-logo-2/512/acer-512.png"></img>
        </a>
        <a className="w-[120px] hover:scale-125" href="">
          <img src="https://scontent.fhan2-4.fna.fbcdn.net/v/t1.15752-9/289381457_3090461431266968_444394360137680767_n.png?_nc_cat=100&ccb=1-7&_nc_sid=ae9488&_nc_ohc=5urmUS3KoDcAX8eDR7O&_nc_ht=scontent.fhan2-4.fna&oh=03_AVLUnV66yOxmNsdjAu7GX9AkL_ymYRqkOQTwugMhhQq4Iw&oe=6302FE55"></img>
        </a>
        <a className="w-[120px] hover:scale-125" href="">
          <img src="https://cdn.iconscout.com/icon/free/png-256/msi-1-286075.png"></img>
        </a>
        <a className="w-[120px] hover:scale-125 " href="">
