    ...
    <div className="page-container">
      ...
      <div className="mt-20">
        ...
        <div className="flex mt-5 justify-center">
          ...
          <div className="">
            <button
              className=" text-white hover:bg-cyan-900 transition-all rounded-lg text-[30px] h-[50px] bg-cyan-600 border mx-1 px-2"
      ...
      <div className="flex gap-x-24 border mb-[190px] border-emerald-400 w-[600px] mx-80 p-3  mt-14">
        <div>
          <NavLink
            to="/policy"
